...
<body>
 ...
 <?php include 'header.php';?>
    ...
    <form action="insertionForm.php"  method = "POST">
    <div  class="form">
       <span>title</span><br>
         <input type="text" name = "titre"> <br> <br>
           <span>Author</span><br>
              ...
              <span>image </span>
           <div class="">
         <input type="file"  name = "imageUpload" style="width:242px;"> <br> <br>
         <span>prix </span>
           <div class="">
...
<input type="text"  name = "quantite" > <br> <br>
  <span>date d'achat</span>  <br>
      <input type="date" id="start" name="date_achat" style="width:200px;" 
         value="2021-04-04"
            min="2019-02-04" max="2025-2-4"> <br> <br>
         <div>
    <span>Date du publication</span><br> 
<input type="date" style="width:200px;" class="form-control"  value="2021-02-04"
            min="2021-02-04" max="2025-2-4" id="date_de_publication" name="date_de_publication" required>
</div> <br> 
